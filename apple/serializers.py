...
from apple.models import Snippet, LANGUAGE_CHOICES, STYLE_CHOICES
...
#         """
#         Update and return an existing 'Sinppet' instance,given validated data
#         :param instance:
